/*
		In this exercise, you'll work with an 
		array and you'll add nodes to the DOM 
		to display the Results and the Scores.
 */
...
const displayResults = () => {
  ...
  const highScoreNode = createElementWithText(
    "p",
